...
<div class="container">
    <div class="row">
        ...
        <form action="login.php" method="post" autocomplete="off">
            ...
            <input type="submit" name="login" value="Login" class="text-uppercase btn bsu text-white" style="background-image: linear-gradient(orange,rgb(179, 129, 37))">
        <br/><a href="signup.php" class="text-decoration-none text-dark">Don't have an account? <b>Create</b></a>
        </div>
    </div>
    </div>
    </div>
...
if(isset($_POST["login"]))
{
    ...
    if(mysqli_num_rows($result)>0)
    {
      ...
      echo "<script>window.location.replace('editprofile.php');</script>";
        ...
        echo "<script>swal('User name or password incorrect!');</script>";
    }
}
