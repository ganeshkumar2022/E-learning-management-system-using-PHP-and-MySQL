...
<p class="text-center" style="font-size:20px;">We provide online <span style="color:orange;">elearning service</span></p>
</div>


<img src="elearning.jpg" class="img-fluid" style="height:70%;width:70vw;margin-left:200px;">
<div class="about bg-primary font-weight-bold" style="padding:50px;">
